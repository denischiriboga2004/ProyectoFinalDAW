...
export default function CreateProductType() {
    ...
    const submit = (event) => {
        ...
        form.post(route('dashboard.productTypes.store'));
    };

    return (
        <AuthenticatedLayout header={<h1 className="text-3xl font-black text-slate-900">Nuevo tipo de producto</h1>}>
            <Head title="Nuevo tipo de producto" />
